jQuery( function( $ ) {
	...
	var WCCorreiosOpenTrackingCode = {
		...
		openTrackingLink: function( evt ) {
			...
			var code  = $( this ).text();
			var form = '<form id="wc-correios-tracking__form" method="post" action="http://www2.correios.com.br/sistemas/rastreamento/resultado.cfm" target="_blank" rel="nofollow noopener noreferrer" style="display: none;">';
