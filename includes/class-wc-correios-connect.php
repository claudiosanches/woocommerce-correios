...
class WC_Correios_Connect {
	...
	const ADDITIONAL_SERVICE_REGISTRO_NACIONAL              = 1,
		  ...
		  ADDITIONAL_SERVICE_CPF_SERVICES                   = 15,
