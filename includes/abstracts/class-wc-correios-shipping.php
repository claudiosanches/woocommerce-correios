	...
	public function init_form_fields() {
		$this->instance_form_fields = array(
			...
			'minimum_height'     => array(
				...
				'type'        => 'text',
				'description' => __( 'Minimum height of your shipping packages. Correios needs at least 1cm.', 'woocommerce-correios' ),
				'desc_tip'    => true,
				'default'     => '1',
			),
			'minimum_width'      => array(
				...
				'type'        => 'text',
				'description' => __( 'Minimum width of your shipping packages. Correios needs at least 10cm.', 'woocommerce-correios' ),
				'desc_tip'    => true,
				'default'     => '10',
			),
			'minimum_length'     => array(
				...
				'type'        => 'text',
				'description' => __( 'Minimum length of your shipping packages. Correios needs at least 15cm.', 'woocommerce-correios' ),
				'desc_tip'    => true,
				'default'     => '15',
			),
			'extra_weight'       => array(
