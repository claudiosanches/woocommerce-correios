<?php
/**
 * Correios PAC MINI shipping method.
 *
 ...
 */
class WC_Correios_Shipping_PAC_MINI extends WC_Correios_Shipping {
	 ...
	 * @var string
	 */
	protected $corporate_code = '04227';
	...
	public function __construct( $instance_id = 0 ) {
		$this->id           = 'correios-pac-mini';
		$this->method_title = __( 'PAC MINI', 'woocommerce-correios' );
