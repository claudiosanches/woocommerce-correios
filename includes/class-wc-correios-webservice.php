...
class WC_Correios_Webservice {
	 ...
	 */
	public function set_minimum_width( $minimum_width = 9 ) {
		$this->minimum_width = 9 <= $minimum_width ? $minimum_width : 9;
	}
	 ...
	 */
	public function set_minimum_length( $minimum_length = 10 ) {
		$this->minimum_length = 10 <= $minimum_length ? $minimum_length : 10;
	}
